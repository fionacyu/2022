...
def retrieveBI(atom1, atom2): # retrieve bond information, returns subsection of dataframe of the possible bonding between two atoms
    ...
    d = {'atom1': ['C','C','C','C','C','C','C','C','C','C','C','C','C','C','C','C','C','C','C','C','C','C','C','C','O','O','N','N','O','C','N','S','O','H','N','N','N','N'],
    'atom2': ['C','C','C','C','Br','Cl','F','I','N','N','N','N','O','O','O','P','P','P','S','S','S','Se','Se','Si','O','O','O','O','S','H','H','H','H','F','N','N','N','N'],
    'bond_type': ['single','aromatic','double','triple','single','single','single','single','single','aromatic','double','triple','single','double','triple','single','double','triple','single','double','triple','single','double','single','single','double','single','double','double','single','single','single','single','single','single','aromatic','double','triple'],
    'av': [1.508,1.396,1.333,1.213,1.9,1.746,1.337,2.124,1.417,1.339,1.286,1.16,1.399,1.197,1.137,1.858,1.673,1.552,1.8,1.587,1.507,1.919,1.693,1.802,1.363,1.204,1.368,1.184,1.435,1.09,1.009,1.345,0.967,0.966,1.523,1.332,1.202,1.12],
    'std': [0.039,0.014,0.024,0.021,0.053,0.047,0.03,0.054,0.05,0.008,0.041,0.008,0.034,0.027,0.012,0,0,0.014,0.038,0.037,0.04,0.056,0.013,0.07,0.119,0.005,0.094,0.038,0.044,0.018,0.043,0.02,0.022,0.069,0.332,0,0.057,0.019],
    'min': [1.37,1.37,1.243,1.187,1.789,1.612,1.262,1.992,1.347,1.328,1.207,1.14,1.32,1.115,1.128,1.858,1.673,1.542,1.714,1.553,1.478,1.855,1.676,1.722,1.116,1.2,1.184,1.066,1.405,0.931,0.836,1.322,0.912,0.917,1.181,1.332,1.139,1.098],
    'max': [1.596,1.432,1.382,1.268,1.95,1.813,1.401,2.157,1.492,1.35,1.338,1.177,1.448,1.272,1.145,1.858,1.673,1.562,1.849,1.647,1.535,1.959,1.709,1.848,1.516,1.208,1.507,1.258,1.5,1.14,1.09,1.4,1.033,1.014,2.236,1.332,1.252,1.133]}
    df = pd.DataFrame(d)
    if atom1 != atom2:
