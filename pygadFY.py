...
class GA:
    ...
    def run(self):
        ...
        # for generation in range(self.num_generations):
            ...
            # print('self.best_solutions_fitness', self.best_solutions_fitness)
        ...
        self.best_solutions_fitness.append(best_solution_fitness)
        # print('self.best_solutions_fitness end: ', self.best_solutions_fitness)
        # print('len of best_solutions_fitness end', len(self.best_solutions_fitness))
